...
define('PLUGSENT_CONNECTOR_VERSION', '0.2.3');
...
register_activation_hook(__FILE__, array('Plugsent_Connector', 'activate'));
register_deactivation_hook(__FILE__, array('Plugsent_Connector', 'deactivate'));
